...
import {getSlideInfo} from '@api/slide/slideApi.ts'

//查询切片信息
const slideInfo = await getSlideInfo(1)
...
const imgWidth = slideInfo.data.width;
const imgHeight = slideInfo.data.height;
// 构建 extent：假设图像左下角为 (0, 0)，右上角为 (width, height)
const extent = [0, 0, imgWidth, imgHeight];
// const zoomifyUrl = 'image/slide/showTileGam/1/14560/1/0/';
const zoomifyUrl = '/slide/showTileGam/1/'+slideInfo.data.imageId+'/1/0/';
