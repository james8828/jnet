...
public class AttachmentController {
    ...
    public R<Boolean> uploadChunk(ChunkUploadVO chunkVO) throws Exception {
        return attachmentService.uploadChunk(chunkVO);
    }
    ...
    public R<Attachment> completeMultipartUpload(@RequestBody ChunkUploadVO chunkVO) {
        return attachmentService.completeMultipartUpload(chunkVO);
    }
